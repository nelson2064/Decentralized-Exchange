// but when we go to exchange we need to have data already data already in our smart contract for the exhcange we don'twant to  have to go to ui  and like add funds and make whole bunch of orders  in order to see how the exchange works we want come prload bunch of orders already i am gonda do this by creating scripts in isde truffle basically seed the exchange that gona preloaded with bunch of data
